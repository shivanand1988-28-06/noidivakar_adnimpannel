...
const NOIDATA_FIELDS = [
  ...
  { label: "Stamp Duty GRN No", value: "stampDutyGRNNo" },
  { label: "Registration GRN No", value: "registrationGRNNo" },
  { label: "Stamp Duty Value", value: "stampDutyValue" },
  { label: "Registration Fee Value", value: "registrationFeeValue" },
  { label: "Registration Fee GRN", value: "registrationFeeGRN" },
  { label: "DHC Charges", value: "dhcCharges" },
  { label: "NOI Charges", value: "noiCharges" },
  { label: "Franking Charges", value: "frankingCharges" },
  { label: "NOI Filing Date", value: "noiFilingDate" },
  { label: "NOI Status", value: "noiStatus" },
  { label: "Document Pending Remark", value: "documentPendingRemark" },
  { label: "SRO Office", value: "sroOffice" },
  { label: "Index 2 No", value: "index2No" },
  { label: "NOI Submitted To RM", value: "noiSubmittedToRM" },
